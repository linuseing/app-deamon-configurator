...
export function SettingsForm({ defaultValues, onSubmit, isSubmitting = false, addonMode = false }: SettingsFormProps) {
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              {...register("appdaemonPath", {
                required: addonMode ? false : "AppDaemon apps folder path is required",
              })}
            />
