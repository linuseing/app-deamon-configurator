...
import { useInstances, useDeleteInstance } from "../hooks/useInstances";
...
export function Instances() {
  ...
  const needsSettings = data?.needsSettings ?? false;
  ...
  const confirmDelete = async () => {
    if (deleteTarget) {
      await deleteInstance.mutateAsync(deleteTarget);
  ...
  useEffect(() => {
    if (deleteInstance.isSuccess) {
      setDeleteTarget(null);
    }
  }, [deleteInstance.isSuccess]);
